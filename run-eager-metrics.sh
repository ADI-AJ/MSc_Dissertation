...
#
# Automates running the Eager-loading pages (REST, then GraphQL) N times
...
echo "=== Eager / REST ==="
PAGE_HTML_PATH="$SCRIPT_DIR/Eager/index-rest.html" \
LABEL="Eager REST" \
node "$SCRIPT_DIR/automation/metrics-runner.js"

echo ""
echo "=== Eager / GraphQL ==="
PAGE_HTML_PATH="$SCRIPT_DIR/Eager/index-graphql.html" \
LABEL="Eager GraphQL" \
node "$SCRIPT_DIR/automation/metrics-runner.js"

echo ""
echo "All Eager runs complete. See metrics/backend_metrics.csv and metrics/frontend_metrics.csv."
